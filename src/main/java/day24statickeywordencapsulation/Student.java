...
public String stdName = "Tom Hanks";
    ...
    public String getSdtId() {  // getSdtId() kullandığımda bana "sdtId" bu değeri ver
        return sdtId;
    }
    ...
    public boolean isRetired() {    // data tipi boolean olduğunda get yerine "is" geldi
        return retired;
    }

    public void setSdtId(String sdtId) {  // set methodunda hep "void" kullanılır.
        this.sdtId = sdtId;               // parametre olarak variable'ın data tipi ve adı yazılır
    }
