...
public class Exceptions02 {
    ...
    public static char getCharFromString(String str, int idx){
        ...
        try{
            ...
            System.out.println("Index ile ilgili bir problem olustu. " + e.getMessage()); //en iyi kullanım (kendi mesajım + javanın mesajı)
            e.printStackTrace(); // Detayli "log" icin
            // log -> akışı takip etmek : app'in adım adım neler yaptığını gösterir
        }
        return c;
    }
}
