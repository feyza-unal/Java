...
*/
    ...
    public static void main(String[] args) {
        double gomlekFiyati = 12.99;
        double tisortFiyati = 54.99;
        double sapkaFiyati = 7.99;
        System.out.println("Toplam Fiyat: " + (gomlekFiyati + tisortFiyati + sapkaFiyati));

        float x = 15.76F;
        long y = 17L;
        int z = 7;
        System.out.println("Çarpım: " + (x*y*z));

        int anapara = 100;
        int oran = 6;
        int yilDegeri = 3;
        System.out.println("Basit Faiz: " + (anapara * oran * yilDegeri ) / 100);
        ...
        float defter = 15.95F;
        float kitap = 29.95F;
        float laptop = 1575.95F;
        float toplamFiyat = (2*defter) + (3*kitap) + (4*laptop);
