...
public class Exceptions02 {
    ...
    /*
        ...
        2) while((k = fis.read()) != -1){} yazdigimizda "read()" method'u hata verir. Cunku biz Java'ya dosya'daki
          karakterleri oku dedik. Java endiseye kapildi i)Ya okumasi gereken karakterler Java'nin bilmedigi karakterlerse.
    ...
    //1.Way:
    public static void readTheTextFromTheFile() throws IOException {   // IOException , FileNotFoundException'ın parent'ıdır
        FileInputStream fis = new FileInputStream("src/main/java/day27exceptions/File1.txt");  // FileInputStream: file'dan data almak için kullanırız
        int k = 0;
        while((k = fis.read()) != -1){
